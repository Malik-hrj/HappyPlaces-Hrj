...
class AddHappyPlaceActivity : AppCompatActivity() , View.OnClickListener, (SQLiteDatabase) -> Unit {
    ...
    companion object {
        ...
        private const val PLACE_AUTOCOMPLETE_RESULT_CODE = 3
    }
        ...
        when (p0!!.id) {
            ...
            R.id.btn_save -> {
                when {
                    ...
                    et_description.text.isNullOrEmpty()-> { Toast.makeText(this, "Please enter descriptions", Toast.LENGTH_SHORT).show() }
            ...
            R.id.et_location -> {
                try {
                    ...
                    startActivityForResult(intent, PLACE_AUTOCOMPLETE_RESULT_CODE)
                } catch (e: Exception) {
                    e.printStackTrace()
                }
            }
                ...
                if (!isLocationEnabled()) {
                    ...
                    Dexter.withActivity(this)
                            .withPermissions(
                                ...
                                override fun onPermissionRationaleShouldBeShown(permission: MutableList<PermissionRequest>?, p1: PermissionToken?) {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            } else if (requestCode == PLACE_AUTOCOMPLETE_RESULT_CODE) {
    ...
    override fun invoke(p1: SQLiteDatabase) {
